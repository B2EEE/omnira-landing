...
const FAQS = [
  ...
  { q:"Que se passe-t-il si l'IA ne comprend pas ?",    a:"L'agent peut reformuler, demander une précision ou transférer à un humain selon les règles définies. Il ne prend jamais de décisions qui dépassent son périmètre configuré." },
        ...
        <div style={{display:'grid',gridTemplateColumns:'1.5fr 1fr 1fr',gap:'48px',marginBottom:'48px'}} className="footer-grid">
          <div>
            ...
            <p style={{fontFamily:'Inter,sans-serif',fontSize:'13px',color:'rgba(255,255,255,0.28)',lineHeight:1.7,marginTop:'14px',maxWidth:'280px'}}>
              Omnira conçoit et déploie des agents vocaux IA pour les entreprises locales. Réponse aux appels, qualification, rendez-vous, devis et résumés automatiques.
            </p>
          </div>
          <div>
